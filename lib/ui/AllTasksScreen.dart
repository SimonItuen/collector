...
class _AllTaskScreenState extends State<AllTaskScreen> {
  ...
  final firebaseAllTaskProvider =
      StreamProvider.autoDispose<List<TodoItem>>((ref) {
    print('listening');
    final stream =
        FirebaseFirestore.instance.collection('todo-list').snapshots();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer(builder: (context, watch, child) {
        return watch(firebaseAllTaskProvider).maybeWhen(
            data: (todoList) {
            ...
            return AlertDialog(
              ...
              actions: [
                TextButton(
                    ...
                    child: Text('Delete Task', style: TextStyle(color: Theme.of(context).errorColor),)),
                TextButton(
                    onPressed: () {
                      Navigator.of(context).pop();
                    },
  ...
  void addTodoItem({required String title, required String description}) {
    TodoListManager()
        .addTodoItem(context, title: title, description: description);
  }
